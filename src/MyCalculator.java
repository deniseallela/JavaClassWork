...
public class MyCalculator extends Frame
{
    ...
    char op;
    //this array will be used to hold the button texts for buttons 1-9
    String digitButtonText[] = {"7", "8", "9", "4", "5", "6",
            "1", "2", "3", "0", "+/-", "." };
    //this array will be used to display text on the operand buttons
    String operatorButtonText[] = {"/", "sqrt", "*", "%", "-", "1/X", "+", "=" };
    //array to hold text for memory buttons
    String memoryButtonText[] = {"MC", "MR", "MS", "M+" };
    String specialButtonText[] = {"Backspc", "C", "CE" };
    //get lenght for each and every array
    MyDigitButton digitButton[]=new MyDigitButton[digitButtonText.length];
    MyOperatorButton operatorButton[]=new MyOperatorButton[operatorButtonText.length];
    MyMemoryButton memoryButton[]=new MyMemoryButton[memoryButtonText.length];
    MySpecialButton specialButton[]=new MySpecialButton[specialButtonText.length];
    //set default value for text label at 0 and position it to the right
    //a label is space for one to input text or values /input field
    Label displayLabel=new Label("0",Label.RIGHT);
    Label memLabel=new Label(" ",Label.RIGHT);
    //size the frame of the calculator
    //using final which is a keyword used when something is constant
...
// set Co-ordinates for Memory Buttons
        ...
        {
            memoryButton[i]=new MyMemoryButton(tempX,y
                    ,WIDTH,HEIGHT,memoryButtonText[i], this);
...
//set Co-ordinates for Special Buttons
        ...
        {
            specialButton[i]=new MySpecialButton(tempX,y,WIDTH*2,
                    HEIGHT,specialButtonText[i], this);
...
//set Co-ordinates for Operator Buttons
    ...
    {
        new MyCalculator("MY FIRST CALCULATOR");
    }
}
